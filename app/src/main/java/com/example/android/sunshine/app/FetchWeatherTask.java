...
public class FetchWeatherTask extends AsyncTask<String, Void, Void> {
	...
	long addLocation(String locationSetting, String cityName, double lat, double lon) {
		...
		if (cursor.moveToNext()) {
			idLocation = cursor.getLong(cursor.getColumnIndex(WeatherContract.LocationEntry._ID));
		} else {
			...
			Uri insert = contentResolver.insert(WeatherContract.LocationEntry.CONTENT_URI, values);
			idLocation = ContentUris.parseId(insert);
		}
		cursor.close();
		return idLocation;
	}
