...
public class TestProvider extends AndroidTestCase {
    ...
    public void testProviderRegistry() {
        ...
        // We define the component name based on the package name from the context and the WeatherProvider class.
        ...
        try {
			...
			String msgAssert = "Error: WeatherProvider registered with authority: "
					+ providerInfo.authority +
					" instead of authority: " + WeatherContract.CONTENT_AUTHORITY;
            assertEquals(msgAssert, providerInfo.authority, WeatherContract.CONTENT_AUTHORITY);
    ...
    public void testUpdateLocation() {
        ...
        Uri locationUri = mContext.getContentResolver().insert(LocationEntry.CONTENT_URI, northPoleLocationValues);
        long locationRowId = ContentUris.parseId(locationUri);

        // Verify we got a row back.
        assertTrue(locationRowId != -1);
        Log.d(LOG_TAG, "New row id: " + locationRowId);
		assertEquals(1, locationRowId);
		WeatherDbHelper weatherDbHelper = new WeatherDbHelper(this.mContext);
		SQLiteDatabase db = weatherDbHelper.getWritableDatabase();

		String whereClause = "_id = ? ";
		String [] whereArgs = new String[] {Long.toString(locationRowId)};

		Cursor cursorAux = db.query(WeatherContract.LocationEntry.TABLE_NAME, null, whereClause, whereArgs, null, null, null);
		assertEquals("New resource found......", 1, cursorAux.getCount());
		TestUtilities.validateCursor("testUpdateLocation.  Error validating location entry update.", cursorAux, northPoleLocationValues);

		ContentValues updatedValues = new ContentValues(northPoleLocationValues);
    ...
    public void testInsertReadProvider() {
		...
		String strAux = "testInsertReadProvider.  Error validating joined Weather and Location data for a specific date.";
        TestUtilities.validateCursor(strAux, weatherCursor, weatherValues);
    }
