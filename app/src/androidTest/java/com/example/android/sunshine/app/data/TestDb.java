...
public class TestDb extends AndroidTestCase {
    ...
    */
    public void testLocationTable() {
        ...
        // Create ContentValues of what you want to insert (you can use the createNorthPoleLocationValues if you wish)
        ...
        // (you can use the validateCurrentRecord function in TestUtilities to validate the query if you like)
    ...
    public void testWeatherTable() {
        ...
        assertTrue("Error: location insert failed.", locationRowId!=-1);
        ...
        assertTrue("Error: weather insert failed.", weatherRowId!=-1);
        ...
        // Validate data in resulting Cursor with the original ContentValues
        // (you can use the validateCurrentRecord function in TestUtilities to validate the query if you like)
        TestUtilities.validateCurrentRecord("Error: validating weather cursor", cursor, weatherValues);
